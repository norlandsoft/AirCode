...
export const zh: Record<TranslationKey, string> = {
  ...
  'settings.providers.ccSwitch.unavailableSchema': '目前 cc-switch 版本的設定結構 AirCode 尚未支援。請更新 AirCode，或手動新增該服務商。',
  ...
  'settings.general.storagePortableDirPlaceholder': '選擇一個用於儲存 AirCode 資料的資料夾',
  ...
  'settings.general.notificationsTestTitle': 'AirCode 通知已啟用',
