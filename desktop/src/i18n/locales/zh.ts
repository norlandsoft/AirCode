...
export const zh: Record<TranslationKey, string> = {
  ...
  'settings.providers.ccSwitch.unavailableSchema': '当前 cc-switch 版本的配置结构 AirCode 尚不认识。请更新 AirCode，或手动添加该服务商。',
  ...
  'settings.general.storagePortableDirPlaceholder': '选择一个用于保存 AirCode 数据的文件夹',
  ...
  'settings.general.notificationsTestTitle': 'AirCode 通知已启用',
