...
export function Workspace() {
  ...
  // Render ALL tabs from ALL projects; CSS hiding keeps them mounted
  // so terminal/editor state survives project switches
      ...
      {!activeProjectId ? (
        ...
        <>
          ...
          <div className="flex-1 relative">
            ...
            {/* Render ALL tabs, hide inactive ones via CSS to preserve state */}
            {tabs.map((tab) => (
              <div
                key={tab.id}
